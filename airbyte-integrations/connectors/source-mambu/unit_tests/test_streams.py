...
import pytest
from source_mambu.source import MambuStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MambuStream, "path", "v0/example_endpoint")
    mocker.patch.object(MambuStream, "primary_key", "test_primary_key")
    mocker.patch.object(MambuStream, "__abstractmethods__", set())
